...
public class GameLevelMgr
{
    ...
    //1.切换到游戏场景时 我们需要动态地创建玩家和初始化面板数据
    ...
    //2.我们需要通过游戏管理器 来判断 游戏是否获胜
    //要知道 场景中 是否还有怪物没有出 以及场景中是否有还没有死亡的怪物
    ...
    public bool CheckOver()
    {
        ...
        {
            //只要有一个出怪点还没出完就无法满足胜利条件1
            if (!points[i].CheckOver())
                return false;
        }
        //只要有当前怪物数量大于1就无法满足胜利条件2
